...
Project:
- BuildZotero
Title: ZoteroScript-P2-Table1统计条目V2
...
(async () => {
  ...
  switch(mode) {
    ...
    case "6": // 全列
      ...
      break;
    case "7": // 变量(6列) + 理论(1列) + 条目信息(4列) + 结果(1列)
      columns.push('A1-DV', 'A2-IV', 'A3-MO', 'A4-ME', 'A5-INV', 'A6-CV', 'Theory', 'V1-变量定义', 'V2-测量方法', 'V3-研究贡献', 'V4-研究展望', 'Result');
      break;
  }
  ...
  itemsData.forEach((data, index) => {
    ...
    switch(mode) {
      ...
      case "6":
        ...
        break;
      case "7":
        row += ` | ${data.a1dv} | ${data.a2iv} | ${data.a3mo} | ${data.a4me} | ${data.a5inv} | ${data.a6cv} | ${data.theory} | ${data.v1def} | ${data.v2mea} | ${data.v3con} | ${data.v4fut} | ${data.result}`;
        break;
    }
