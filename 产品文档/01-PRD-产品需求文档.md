...
1. [产品概述](#产品概述)
2. [AI Agent 架构设计理念](#ai-agent-架构设计理念)
3. [产品核心范式转移](#产品核心范式转移)
4. [需求分析与场景定位](#需求分析与场景定位)
5. [用户画像](#用户画像)
6. [核心需求](#核心需求)
7. [功能需求](#功能需求)
8. [技术架构](#技术架构)
...
| Tag3- 方法标签 | 研究方法与技术 | `sMeth/1-6` | P0 | 方法论指纹：研究类型、主要分析、辅助分析 |
| Tag4- 样本标签 | 研究层次与样本特征 | `Sample/1-3` | P0 | 研究层次、研究领域、研究样本 |
| Tag5- 理论标签 | 理论框架与机制 | `Theory/序号` | P0 | **标准理论库匹配 + 新理论标记** |
| Tag6- 结论标签 | 研究发现与结论 | `Result/序号` | P0 | 主要结论、次要结论 |
| Tag7- 变量标签 | 变量定义与关系 | `A1-DV/`, `A2-IV/` 等 | P0 | **因果链条**：因变量、自变量、中介变量、调节变量等 |
| Tag8- 条目细节标签 | 研究贡献与展望 | `V1-def/`, `V3-con/` 等 | P0 | 变量定义、测量方法、研究贡献、未来展望 |
...
- [README.md](4-WorkProjects/02TS/BuildZotero/README.md) - 产品概述与使用指南
- [所有最新版本代码集合.md](../Scripts/所有最新版本代码集合.md) - 代码索引
- [文献标签管理体系设计主题架构.md](../Scripts/Zotero-Script-P1-Tag0-文献标签管理体系设计主题架构.md) - 系统架构设计
- [技术架构与产品优势分析.md](06-技术架构与产品优势分析.md) - 技术架构深度分析（必读）
